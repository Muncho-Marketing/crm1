/*
  # Generate sample data for restaurant analytics

  1. Creates sample orders for different customer segments
  2. Updates customer statistics based on orders
  3. Creates loyalty rewards and redemptions
  4. Generates feedback entries
  5. Creates QR codes for restaurants
  6. Generates campaign history
  7. Updates credits balance
